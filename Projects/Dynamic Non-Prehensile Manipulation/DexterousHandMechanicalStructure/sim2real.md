...
|---------|----------|---------|---------|-------|-----------------|
| [[电机#1. 有刷直流电机\|有刷直流电机]] | 高（$\tau = K_t I$） | 中（电感+机械） | 无 | 中（电刷磨损） | ⭐⭐⭐ |
| [[电机#2. 无刷直流电机\|BLDC (FOC)]] | **极高** | **极低**（FOC 带宽 > 1kHz） | 有（可通过 FOC 补偿） | 低 | ⭐⭐⭐⭐ |
| [[电机#3. 无框力矩电机\|无框力矩电机]] | **极高** | **极低** | 低 | 中（散热依赖结构） | ⭐⭐⭐⭐⭐ |
| [[电机#4. 空心杯电机\|空心杯电机]] | **极高** | **极低**（惯量最小） | **零** | 差（无铁芯散热差） | ⭐⭐⭐⭐ |
| [[电机#5. 伺服电机系统\|RC 舵机]] | 低（齿轮组非线性） | 高（多级齿轮惯量） | 有 | 中 | ⭐ |
...
|-----------|------|----------|---------|---------|-----------------|
| [[减速器#2.1 行星齿轮箱\|行星齿轮箱]] | ⚠️ 中（8–15 arcmin） | 中 | 低 | 良好 | ⭐⭐⭐ |
| [[减速器#2.3 蜗轮蜗杆减速器\|蜗轮蜗杆]] | 低 | **极高**（自锁） | 低 | **不可** | ⭐ |
| [[减速器#2.4 谐波减速器\|谐波减速器]] | ✅ 零 | 中偏高 | **高（非线性）** | 中偏差 | ⭐⭐⭐ |
| [[减速器#2.5 摆线针轮减速器\|摆线针轮]] | 低 | 中 | 低 | 中 | ⭐⭐⭐ |
| 无减速器（直驱） | ✅ 零 | **极低** | **零** | **最佳** | ⭐⭐⭐⭐⭐ |
| 低比减速（QDD） | 低 | 低 | 极低 | 良好 | ⭐⭐⭐⭐ |
...
> [!warning] 谐波减速器的零背隙优势
> [[减速器#2.4 谐波减速器|谐波减速器]]的弹性预载使其实现零背隙——这是其在灵巧手中被广泛采用的核心原因之一。从 Sim-to-Real 角度，零背隙显著降低了仿真与真机之间的力矩传递差异。
...
**现象**：[[减速器#2.4 谐波减速器|谐波减速器]]的柔轮在传递力矩时发生弹性变形，关节实际角度 $q_{actual}$ 与电机编码器测量角度 $q_{encoder}$ 之间存在偏差：
