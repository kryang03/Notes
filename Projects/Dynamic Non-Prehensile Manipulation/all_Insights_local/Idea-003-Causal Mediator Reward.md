...
### 与 Foundations 的联系
- [[ReinforcementLearning]] — CMR 的理论定位：介于 dense 和 sparse 之间的原理性 reward design
- [[InformationTheory]] — Mediator 的信息论解读：$V_M$ 编码了 mediator 对最终结果的互信息
- [[Dynamics]] — 因果链第2步（角速度→离心力→接触力）的物理基础
- [[ContactMechanics]] — 因果链第3-4步（接触力→摩擦力）的物理基础
