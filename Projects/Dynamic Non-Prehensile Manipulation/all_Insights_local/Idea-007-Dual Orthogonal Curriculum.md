...
### 与 Foundations 的联系
- [[ReinforcementLearning]] — ZVF 的"只在有效难度下训练"思想与 Scaling Law 的"最优计算分配"一脉相承
- [[Optimization]] — 双轴课程将 landscape 的探索难度在两个独立维度上渐进学习
- [[ReinforcementLearning]] — 状态初始化课程本质上是 intrinsic motivation 的显式替代
