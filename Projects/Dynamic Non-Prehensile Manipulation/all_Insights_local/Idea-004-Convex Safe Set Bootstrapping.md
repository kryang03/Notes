...
### 与 Foundations 的联系
- [[Optimization]] — CSS 将 Value Landscape 中的 "稀疏踏脚石" 用凸几何连接起来
- [[InformationTheory]] — CSS 可视为 empowerment 的几何替代：处于 CSS 内的状态 "对未来有更多控制力"
- [[ReinforcementLearning]] — CSS 边界探索是 intrinsic motivation 的几何实例化
